  ...
  return (
    <div className="flex items-center gap-4 flex-wrap mt-2 px-2">
      ...
      <Card
        ...
        className={`${theme === "light" ? "ring-2 ring-gray-400 ring-offset-2" : ""} flex flex-col bg-[#fafafabd]  shadow-none rounded-md w-[150px] h-[100px] justify-end items-end `}
      >
     ...
     <Card
        ...
        className={`${theme === "dark" ? "ring-1 ring-gray-300 ring-offset-2" : ""} flex flex-col bg-black/50 shadow-none rounded-md w-[150px] h-[100px] justify-end items-end`}
      >
      ...
      <Card
        ...
        className={`${theme === "system" ? "ring-1 ring-gray-300 ring-offset-2" : ""} flex  bg-black/50 shadow-none rounded-md w-[150px] h-[100px] justify-end items-end`}
      >
